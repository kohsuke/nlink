...
class Wrapper implements InvocationHandler {
    ...
    Wrapper(Class dllInterface, String libPath) {
    ...
    private class Invoker {
        ...
        public Invoker(Method m, DllMethod dm) {
            ...
            if(name.startsWith("#")) {
                functionPtr = Native.getProcAddress2(hModule,Integer.parseInt(name.substring(1)));
            } else {
                functionPtr = Native.getProcAddress(hModule,name);
            }

            if(functionPtr==0)
                throw new Win32NLinkException("Failed to find a function for "+m.getName());
        ...
        Object invoke( Object[] args ) {
            ...
            try {
                Object r = Native.invoke( functionPtr, args, paramConvs,
                    method.getReturnType(), returnConv.code );
